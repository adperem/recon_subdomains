...
echo "[✔ ] wayback machine completed"
# VirusTotal siblings
...
echo "[✔ ] IP step completed"

# Sort unique IPs
#sort -u "$output_dir/ips.txt" -o "$output_dir/ips.txt"

# Shodan (requires SHODAN_API_KEY exported)
...
echo "[+] All results are located in $output_dir/"
